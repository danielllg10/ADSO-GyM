                        ...
                        <div class="row g-0">
                                    ...
                                    <form action="<?php echo e(route('register')); ?> " method="post">
                                        ...
                                        <div class="form-outline mb-4">
                                            ...
                                            <input type="password" name="password" id="form2Example22"
                                                class="form-control" placeholder="contraseña minimo 8 caracteres" />
                            ...
                            <div class="col-lg-6 d-flex align-items-center gradient-custom-2">
                                <div class="text-white px-3 py-4 p-md-5 mx-md-4">
                                    ...
                                    <p class="small mb-0">No pierdas más tiempo y regístrate hoy mismo para descubrir
                                        ...
                                        ¡No esperes más y descubre todo lo que tenemos preparado para ti!</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\ferreteria\resources\views/auth/register.blade.php ENDPATH**/ ?>