        ...
        <div class="dash-content">
            <div class="overview">
                <div class="activity">
                    ...
                    <a class="btn btn-outline-success" href="<?php echo e(url('/pag_dash_productos/create')); ?>">Registrar una
                        provedor</a>
                    <br>
<br>
                        ...
                        <table class="table table-dark">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <img class="img-thmbnail img-fluid" src="<?php echo e(asset('storage').'/'.$producto->Foto); ?>" width="100" alt="">
                                    </td>
