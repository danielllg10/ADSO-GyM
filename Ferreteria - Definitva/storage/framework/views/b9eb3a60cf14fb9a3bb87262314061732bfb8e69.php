    ...
    <nav>
        ...
        <div class="menu-items">
            <ul class="nav-links">
                ...
                <li><a href="/html/submenu_dashboard/pag_dash_provee.html">
                    <i class="fa-solid fa-truck-fast"></i>
                        <span class="link-name">Proveedores</span>
                    </a></li>
                <li><a href="/html/submenu_dashboard/pag_dash_produc.html">
                    <i class="fa-brands fa-product-hunt"></i>
                        <span class="link-name">Productos</span>
                    </a></li>
                <li><a href="/html/pag_error404.html" target="_blank">
                    <i class="fa-sharp fa-solid fa-square-xmark"></i>
                        <span class="link-name">Error 404</span>
                    </a></li>
                <li><a href="/html/pag_error500.html" target="_blank">
                    <i class="fa-sharp fa-solid fa-square-xmark"></i>
            ...
            <ul class="logout-mode">
                <li><a href="/html/pag_cuenta.html">
...
<?php /**PATH C:\xampp\htdocs\ferreteria\resources\views//pag_dashboard.blade.php ENDPATH**/ ?>