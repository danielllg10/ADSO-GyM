    ...
    <div class="contenedor">
      <div class="caja">
        ...
        <form action="/pag_dashboard">
          ...
          <div class="signup-link">No tienes cuenta creada? <a class="crear" href="<?php echo e(route('register')); ?>">Crea una aqui</a></div>
        </form>
      </div>
    </div>
...
<?php /**PATH C:\Users\EQUIPO\Desktop\ferreteria\resources\views/auth/login.blade.php ENDPATH**/ ?>