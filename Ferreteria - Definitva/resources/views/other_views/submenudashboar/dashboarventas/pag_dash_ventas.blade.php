        ...
        <div class="dash-content">
            <div class="overview">
                <div class="activity">
                    ...
                    @endif
                        <a class="btn btn-outline-success" href="{{ url('/pag_dash_ventas/create') }}">Registrar una
                            Venta</a>
                        <a class="btn btn-outline-primary" href="{{ url('/pag_dash_ventas/pdf') }}">Generar
                            informes</a>
                        <br>
                        <br>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a class="btn btn-warning"
                                                    href="{{ url('/pag_dash_ventas/' . $venta->id . '/edit') }}">
                                                    Editar
                                                </a>



                                                <form action="{{ url('/pag_dash_ventas/' . $venta->id) }}"
                                                    class="d-inline"
                                                    method="POST">
                                                    @csrf
                                                    {{ method_field('DELETE') }}
